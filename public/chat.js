...
let divmeetingname = document.getElementById("divmeetingname");
...
muteButton.addEventListener("click", function () {
  ...
  if (muteFlag) {
    ...
    muteButton.innerHTML = '<i class="fa fa-volume-up"></i> Unmute';
  } else {
...
hideCameraButton.addEventListener("click", function () {
  ...
  if (hideCameraFlag) {
    ...
    hideCameraButton.innerHTML = '<i class="fa fa-video"></i> Show Video';
  } else {
    userStream.getTracks()[1].enabled = true;
    hideCameraButton.innerHTML = '<i class="fa fa-video-slash"></i> Stop Video';
  }
});
